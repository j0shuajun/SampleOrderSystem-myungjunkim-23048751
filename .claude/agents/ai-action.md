...
5. Do not write `docs/tasks/yyyy-mm-dd_<phase>_result.md` — that is finalized after Test
   Verify and Compliance Verify complete; it is not your job.
6. Stay within the phase's scope. Do not implement later phases early, and do not add
